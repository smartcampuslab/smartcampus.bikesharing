 ...
 * {@link SafeTranslatedCanvas} to work around various Android issues with large
 * canvases. For the two classes to work together, call
 * {@link #onDrawCycleStart} at the start of the {@link Overlay#drawSafe} method
 * of your {@link Overlay}. This will set the adjustment needed to draw your
 * Path safely on the canvas without any drawing distortion at high zoom levels.
 * Methods of the {@link Path} class that use unsafe float types have been
 * deprecated in favor of replacement methods that use doubles.
 * 
...
public class SafeTranslatedPath extends Path
{
	...
	/**
	 * This method <b>must</b> be called at the start of the
	 * {@link Overlay#drawSafe} draw cycle method. This will adjust the Path to
	 * the current state of the {@link ISafeCanvas} passed to it.
	 */
	...
	public void computeBounds(Rect bounds, boolean exact)
	{
		...
		bounds.set((int) sRectF.left, (int) sRectF.top, (int) sRectF.right,
				(int) sRectF.bottom);
		bounds.offset(-xOffset, -yOffset);
	}
	...
	{
		super.quadTo((float) (x1 + xOffset), (float) (y1 + yOffset),
				(float) (x2 + xOffset), (float) (y2 + yOffset));
	}
	...
	/**
	 * @deprecated Use
	 *             {@link #cubicTo(double, double, double, double, double, double)}
	 *             instead.
	 */
	@Override
	public void cubicTo(float x1, float y1, float x2, float y2, float x3,
			float y3)
	{
		super.cubicTo(x1 + xOffset, y1 + yOffset, x2 + xOffset, y2 + yOffset,
	 ...
	 */
	public void cubicTo(double x1, double y1, double x2, double y2, double x3,
			double y3)
	{
		super.cubicTo((float) (x1 + xOffset), (float) (y1 + yOffset),
				(float) (x2 + xOffset), (float) (y2 + yOffset),
				(float) (x3 + xOffset), (float) (y3 + yOffset));
	}
	...
	/**
	 * @deprecated use
	 *             {@link #addRect(double, double, double, double, Direction)}
	 */
	@Override
	public void addRect(float left, float top, float right, float bottom,
			Direction dir)
	{
		super.addRect(left + xOffset, top + yOffset, right + xOffset, bottom
				+ yOffset, dir);
	}
	 ...
	 */
	public void addRect(double left, double top, double right, double bottom,
			Direction dir)
	{
		super.addRect((float) (left + xOffset), (float) (top + yOffset),
				(float) (right + xOffset), (float) (bottom + yOffset), dir);
	}
	...
	{
		super.addCircle((float) (x + xOffset), (float) (y + yOffset), radius,
				dir);
	}
