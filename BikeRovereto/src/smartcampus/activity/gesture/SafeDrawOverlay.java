...
/**
 * An overlay class that uses the safe drawing canvas to draw itself and can be
 * zoomed in to high levels without drawing issues.
 * 
...
public abstract class SafeDrawOverlay extends Overlay
{
	...
	protected abstract void drawSafe(final ISafeCanvas c, final MapView osmv,
